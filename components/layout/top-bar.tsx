        ...
        <div className="flex items-center gap-2">
          ...
          {session?.user && (
            <Link
              ...
              className="hidden md:flex h-8 w-8 items-center justify-center rounded-full gradient-primary text-xs font-bold text-white overflow-hidden hover:ring-2 hover:ring-primary/30 transition-all"
            >
              {avatar ? (
