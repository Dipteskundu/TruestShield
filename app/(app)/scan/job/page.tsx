    ...
    <div className="space-y-6">
      <div className="space-y-2 animate-fade-in-up">
        ...
        <p className="text-muted-foreground">
          Spot fake job listings, upfront payment scams, and work-from-home fraud
        </p>
      </div>
      ...
      <div className="flex items-start gap-3 rounded-xl border border-border/50 bg-primary/5 p-4">
        ...
        <p className="leading-relaxed text-sm">{TYPE_GUIDANCE.job}</p>
      </div>
