...
const type = "message" as ScanType;
    ...
    <div className="space-y-6">
      <div className="space-y-2 animate-fade-in-up">
        ...
        <p className="text-muted-foreground">
          Check SMS, WhatsApp, and chat messages for scam patterns
        </p>
      </div>
      ...
      <div className="flex items-start gap-3 rounded-xl border border-border/50 bg-primary/5 p-4">
        ...
        <p className="leading-relaxed text-sm">{TYPE_GUIDANCE.message}</p>
      </div>
