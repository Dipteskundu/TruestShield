    ...
    <div className="space-y-6">
      <div className="space-y-2 animate-fade-in-up">
        ...
        <p className="text-muted-foreground">
          Detect phishing and spoofed sender patterns in emails
        </p>
      </div>

      <CreditBadge remaining={remaining} limit={isGuest ? 2 : 20} isPro={isPro} isGuest={isGuest} />
      ...
      <div className="flex items-start gap-3 rounded-xl border border-border/50 bg-primary/5 p-4">
        ...
        <p className="leading-relaxed text-sm">{TYPE_GUIDANCE.email}</p>
      </div>
